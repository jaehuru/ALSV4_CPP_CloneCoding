...
#include "HuruAnimationStructLibrary.generated.h"

USTRUCT(BlueprintType)
struct FHuruDynamicMontageParams
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Huru|Dynamic Transition")
...
USTRUCT(BlueprintType)
struct FHuruLeanAmount
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Huru|Anim Graph - Grounded")
	float LR = 0.0f;
...
USTRUCT(BlueprintType)
struct FHuruTurnInPlaceAsset
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	TObjectPtr<UAnimSequenceBase> Animation = nullptr;
...
USTRUCT(BlueprintType)
struct FHuruAnimCharacterInformation
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Huru|Character Information")
...
USTRUCT(BlueprintType)
struct FHuruAnimGraphGrounded
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadWrite, Category = "Huru|Anim Graph - Grounded")
	EHuruHipsDirection TrackedHipsDirection = EHuruHipsDirection::F;

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Huru|Anim Graph - Grounded")
	bool bShouldMove = false; // 초기에는 false여야 한다
...
USTRUCT(BlueprintType)
struct FHuruAnimGraphInAir
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Huru|Anim Graph - In Air")
	bool bJumped = false;
...
USTRUCT(BlueprintType)
struct FHuruAnimGraphAimingValues
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Huru|Anim Graph - Aiming Values")
...
USTRUCT(BlueprintType)
struct FHuruAnimGraphLayerBlending
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Huru|Anim Graph - Layer Blending")
...
USTRUCT(BlueprintType)
struct FHuruAnimGraphFootIK
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Huru|Anim Graph - Foot IK")
...
struct FHuruAnimTurnInPlace
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset N_TurnIP_L90;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset N_TurnIP_R90;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset N_TurnIP_L180;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset N_TurnIP_R180;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset CLF_TurnIP_L90;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset CLF_TurnIP_R90;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset CLF_TurnIP_L180;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Turn In Place")
	FHuruTurnInPlaceAsset CLF_TurnIP_R180;
};

USTRUCT(BlueprintType)
struct FHuruAnimRotateInPlace
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Rotate In Place")
...
USTRUCT(BlueprintType)
struct FHuruAnimConfiguration
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Main Configuration")
	...
	/** 여러 애니메이션에서 동적 전환을 활성화하기 위한 임계값 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Huru|Main Configuration")
