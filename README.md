...
1. 애니메이션 리타겟팅을 하게 되면 당연스럽게 Additive Animation 설정이 초기값인 'No additive'로 설정되어 있었고 이 애니메이션들이랑 애니메이션들이 연결된 블랜드스페이스를 애니메이션 블루프린트에서 사용하게 되면 캐릭터가 뒤틀리고 괴물처럼 변하였다.
